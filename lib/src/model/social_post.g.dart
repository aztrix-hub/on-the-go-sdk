...
final BuiltSet<SocialPostTypeEnum> _$socialPostTypeEnumValues =
    BuiltSet<SocialPostTypeEnum>(const <SocialPostTypeEnum>[
...
final BuiltSet<SocialPostAlertTypeEnum> _$socialPostAlertTypeEnumValues =
    BuiltSet<SocialPostAlertTypeEnum>(const <SocialPostAlertTypeEnum>[
...
final BuiltSet<SocialPostStatusEnum> _$socialPostStatusEnumValues =
    BuiltSet<SocialPostStatusEnum>(const <SocialPostStatusEnum>[
...
class SocialPostBuilder implements Builder<SocialPost, SocialPostBuilder> {
  ...
  SetBuilder<String> get labels => _$this._labels ??= SetBuilder<String>();
  ...
  ListBuilder<int> get businessIds =>
      _$this._businessIds ??= ListBuilder<int>();
  ...
  ListBuilder<int> get listingPageIds =>
      _$this._listingPageIds ??= ListBuilder<int>();
  ...
  ListBuilder<int> get businessPageIds =>
      _$this._businessPageIds ??= ListBuilder<int>();
  ...
  ListBuilder<String> get directories =>
      _$this._directories ??= ListBuilder<String>();
  ...
  ListBuilder<String> get videos => _$this._videos ??= ListBuilder<String>();
