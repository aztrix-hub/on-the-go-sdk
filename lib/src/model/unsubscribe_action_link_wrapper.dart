...
part 'unsubscribe_action_link_wrapper.g.dart';
...
abstract class UnsubscribeActionLinkWrapper
  ...
  UnsubscribeActionLinkWrapperErrorCodeEnum? get errorCode;
  ...
  UnsubscribeActionLinkObject? get response;
...
class _$UnsubscribeActionLinkWrapperSerializer
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.response != null) {
      ...
      yield serializers.serialize(
        object.response,
        specifiedType: const FullType(UnsubscribeActionLinkObject),
      );
    }
  }
  ...
  void _deserializeProperties(
    ...
    required UnsubscribeActionLinkWrapperBuilder result,
      ...
      switch (key) {
        ...
        case r'response':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(UnsubscribeActionLinkObject),
          ) as UnsubscribeActionLinkObject;
  ...
  @override
  UnsubscribeActionLinkWrapper deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = UnsubscribeActionLinkWrapperBuilder();
