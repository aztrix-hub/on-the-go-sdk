...
part of 'ai_chat_data_post200_response_actions.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$AiChatDataPost200ResponseActions
    extends AiChatDataPost200ResponseActions {
  @override
  ...
  factory _$AiChatDataPost200ResponseActions(
          [void Function(AiChatDataPost200ResponseActionsBuilder)? updates]) =>
      (AiChatDataPost200ResponseActionsBuilder()..update(updates))._build();

  _$AiChatDataPost200ResponseActions._(
      {this.search,
      this.keywords,
      this.description,
      this.openingHours,
      ...
      : super._();
  @override
  AiChatDataPost200ResponseActions rebuild(
          void Function(AiChatDataPost200ResponseActionsBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  AiChatDataPost200ResponseActionsBuilder toBuilder() =>
      AiChatDataPost200ResponseActionsBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is AiChatDataPost200ResponseActions &&
        search == other.search &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'AiChatDataPost200ResponseActions')
          ..add('search', search)
...
class AiChatDataPost200ResponseActionsBuilder
    implements
        Builder<AiChatDataPost200ResponseActions,
            AiChatDataPost200ResponseActionsBuilder> {
  _$AiChatDataPost200ResponseActions? _$v;
  ...
  AiChatDataPost200ResponseActionsBuilder() {
    AiChatDataPost200ResponseActions._defaults(this);
  }

  AiChatDataPost200ResponseActionsBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(AiChatDataPost200ResponseActions other) {
    _$v = other as _$AiChatDataPost200ResponseActions;
  }

  @override
  void update(void Function(AiChatDataPost200ResponseActionsBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  AiChatDataPost200ResponseActions build() => _build();

  _$AiChatDataPost200ResponseActions _build() {
    _$AiChatDataPost200ResponseActions _$result;
    try {
      _$result = _$v ??
          _$AiChatDataPost200ResponseActions._(
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'AiChatDataPost200ResponseActions', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
