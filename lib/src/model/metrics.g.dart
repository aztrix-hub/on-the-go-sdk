...
class _$Metrics extends Metrics {
  ...
  factory _$Metrics([void Function(MetricsBuilder)? updates]) =>
      (MetricsBuilder()..update(updates))._build();
  ...
  @override
  MetricsBuilder toBuilder() => MetricsBuilder()..replace(this);
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'Metrics')
