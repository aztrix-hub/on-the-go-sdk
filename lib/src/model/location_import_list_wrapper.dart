...
part 'location_import_list_wrapper.g.dart';
...
abstract class LocationImportListWrapper
  ...
  LocationImportListWrapperErrorCodeEnum? get errorCode;
  ...
  LocationImportListObject? get response;
...
class _$LocationImportListWrapperSerializer
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.status != null) {
      ...
      yield serializers.serialize(
        object.status,
        specifiedType: const FullType(LocationImportListWrapperStatusEnum),
      );
    }
    ...
    if (object.response != null) {
      ...
      yield serializers.serialize(
        object.response,
        specifiedType: const FullType(LocationImportListObject),
      );
    }
  }
  ...
  void _deserializeProperties(
    ...
    required LocationImportListWrapperBuilder result,
      ...
      switch (key) {
        case r'status':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(LocationImportListWrapperStatusEnum),
          ) as LocationImportListWrapperStatusEnum;
  ...
  @override
  LocationImportListWrapper deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = LocationImportListWrapperBuilder();
