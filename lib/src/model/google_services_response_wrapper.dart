...
part 'google_services_response_wrapper.g.dart';
...
abstract class GoogleServicesResponseWrapper
  ...
  GoogleServicesResponseWrapperErrorCodeEnum? get errorCode;
  ...
  GoogleServicesResponseObject? get response;
...
class _$GoogleServicesResponseWrapperSerializer
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.response != null) {
      ...
      yield serializers.serialize(
        object.response,
        specifiedType: const FullType(GoogleServicesResponseObject),
      );
    }
  }
  ...
  void _deserializeProperties(
    ...
    required GoogleServicesResponseWrapperBuilder result,
      ...
      switch (key) {
        ...
        case r'response':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(GoogleServicesResponseObject),
          ) as GoogleServicesResponseObject;
  ...
  @override
  GoogleServicesResponseWrapper deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = GoogleServicesResponseWrapperBuilder();
