...
part 'data_point_filters_response_wrapper.g.dart';
...
abstract class DataPointFiltersResponseWrapper
  ...
  DataPointFiltersResponseWrapperErrorCodeEnum? get errorCode;
  ...
  DataPointFiltersResponseObject? get response;
...
class _$DataPointFiltersResponseWrapperSerializer
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.response != null) {
      ...
      yield serializers.serialize(
        object.response,
        specifiedType: const FullType(DataPointFiltersResponseObject),
      );
    }
  }
      ...
      switch (key) {
        ...
        case r'response':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(DataPointFiltersResponseObject),
          ) as DataPointFiltersResponseObject;
  ...
  @override
  DataPointFiltersResponseWrapper deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = DataPointFiltersResponseWrapperBuilder();
