...
part 'product_plan_list_response_wrapper.g.dart';
...
abstract class ProductPlanListResponseWrapper
  ...
  ProductPlanListResponseWrapperErrorCodeEnum? get errorCode;
  ...
  ProductPlanListResponseObject? get response;
...
class _$ProductPlanListResponseWrapperSerializer
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.response != null) {
      ...
      yield serializers.serialize(
        object.response,
        specifiedType: const FullType(ProductPlanListResponseObject),
      );
    }
  }
  ...
  void _deserializeProperties(
    ...
    required ProductPlanListResponseWrapperBuilder result,
      ...
      switch (key) {
        ...
        case r'response':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(ProductPlanListResponseObject),
          ) as ProductPlanListResponseObject;
  ...
  @override
  ProductPlanListResponseWrapper deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ProductPlanListResponseWrapperBuilder();
