...
class InboxApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [InboxItemChildrenGet200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<InboxItemChildrenGet200Response>> inboxItemChildrenGet({
    required String id,
    ...
    InboxItemChildrenGet200Response? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(InboxItemChildrenGet200Response),
            ) as InboxItemChildrenGet200Response;
    ...
    return Response<InboxItemChildrenGet200Response>(
      data: _responseData,
  ...
  Future<Response<InboxItem>> inboxItemGet({
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(InboxItem),
            ) as InboxItem;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
  ...
  Future<Response<InboxPost200Response>> inboxPost({
    ...
    try {
      const _type = FullType(InboxPostRequest);
      _bodyData =
          _serializers.serialize(inboxPostRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
  ...
  Future<Response<DataPoint>> inboxReplyPost({
    ...
    try {
      const _type = FullType(InboxReplyPostRequest);
      _bodyData =
          _serializers.serialize(inboxReplyPostRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
