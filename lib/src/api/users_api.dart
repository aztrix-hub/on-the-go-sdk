...
class UsersApi {
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UserLoginOauthPost200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserLoginOauthPost200Response>> userLoginOauthPost({
    required UserLoginOauthPostRequest userLoginOauthPostRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/user/login/oauth';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(UserLoginOauthPostRequest);
      _bodyData = _serializers.serialize(userLoginOauthPostRequest,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
    ...
    UserLoginOauthPost200Response? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(UserLoginOauthPost200Response),
            ) as UserLoginOauthPost200Response;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<UserLoginOauthPost200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [Login] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Login>> userOtpLoginCompletePost({
    required UserOtpLoginCompletePostRequest userOtpLoginCompletePostRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/user/otp-login/complete';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(UserOtpLoginCompletePostRequest);
      _bodyData = _serializers.serialize(userOtpLoginCompletePostRequest,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserOtpLoginPost200Response>> userOtpLoginPost({
    required UserOtpLoginPostRequest userOtpLoginPostRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(UserOtpLoginPostRequest);
      _bodyData =
          _serializers.serialize(userOtpLoginPostRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UserTypePost200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserTypePost200Response>> userTypePost({
    required UserTypePostRequest userTypePostRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(UserTypePostRequest);
      _bodyData =
          _serializers.serialize(userTypePostRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
    ...
    UserTypePost200Response? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(UserTypePost200Response),
            ) as UserTypePost200Response;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<UserTypePost200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
