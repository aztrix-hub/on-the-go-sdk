...
class LocationsApi {
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [LocationDelete200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<LocationDelete200Response>> locationDelete({
    required LocationDeleteRequest locationDeleteRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(LocationDeleteRequest);
      _bodyData =
          _serializers.serialize(locationDeleteRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
    ...
    LocationDelete200Response? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(LocationDelete200Response),
            ) as LocationDelete200Response;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<LocationDelete200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [LocationListingConnectGet200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<LocationListingConnectGet200Response>>
      locationListingConnectGet({
    ...
    final _path = r'/location/listing/connect';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    LocationListingConnectGet200Response? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType:
                  const FullType(LocationListingConnectGet200Response),
            ) as LocationListingConnectGet200Response;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<LocationListingConnectGet200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [Location] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Location>> locationPatch({
    required String id,
  ...
  /// Returns a [Future] containing a [Response] with a [Location] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Location>> locationPhotoPost({
  ...
  /// Returns a [Future] containing a [Response] with a [Location] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Location>> locationPost({
    required Location location,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [LocationsListingsGet200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<LocationsListingsGet200Response>> locationsListingsGet({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    LocationsListingsGet200Response? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(LocationsListingsGet200Response),
            ) as LocationsListingsGet200Response;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
