...
class LocationsApi {
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<ListingConflict>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<ListingConflict>>> locationListingConflictsPost({
    ...
    final _path = r'/location/listing/conflicts';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BuiltList<ListingConflict>? _responseData;
    ...
    return Response<BuiltList<ListingConflict>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<LocationListingSyncPost200Response>> locationListingSyncPost({
    ...
    final _path = r'/location/listing/sync';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [Location] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Location>> publicLocationGet({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
