...
class ConnectionsApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<ConnectionLocationAction>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<ConnectionLocationAction>>>
    ...
    final _path = r'/connection/location/actions';
    ...
    BuiltList<ConnectionLocationAction>? _responseData;
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              ...
              specifiedType: const FullType(
                  BuiltList, [FullType(ConnectionLocationAction)]),
            ) as BuiltList<ConnectionLocationAction>;
    ...
    return Response<BuiltList<ConnectionLocationAction>>(
      data: _responseData,
  ...
  Future<Response<ConnectionLocationPost200Response>> connectionLocationPost({
    ...
    final _path = r'/connection/location';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> connectionLocationVerificationCompletePost({
    required ConnectionLocationVerificationCompletePostRequest
        connectionLocationVerificationCompletePostRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/connection/location/verification/complete';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(ConnectionLocationVerificationCompletePostRequest);
  ...
  Future<Response<void>> connectionLocationVerificationPost({
    ...
    final _path = r'/connection/location/verification';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(ConnectionLocationVerificationPostRequest);
      _bodyData = _serializers.serialize(
          connectionLocationVerificationPostRequest,
          specifiedType: _type);
    } catch (error, stackTrace) {
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<ConnectionLocationsGet200ResponseInner>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<ConnectionLocationsGet200ResponseInner>>>
    ...
    BuiltList<ConnectionLocationsGet200ResponseInner>? _responseData;
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              ...
              specifiedType: const FullType(BuiltList,
                  [FullType(ConnectionLocationsGet200ResponseInner)]),
            ) as BuiltList<ConnectionLocationsGet200ResponseInner>;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<BuiltList<ConnectionLocationsGet200ResponseInner>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Connection>> connectionPost({
    required ConnectionPostRequest connectionPostRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(ConnectionPostRequest);
      _bodyData =
          _serializers.serialize(connectionPostRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  Future<Response<BuiltList<Connection>>> connectionsGet({
    ...
    BuiltList<Connection>? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(BuiltList, [FullType(Connection)]),
            ) as BuiltList<Connection>;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<BuiltList<Connection>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
