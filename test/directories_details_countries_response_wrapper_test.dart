...
// tests for DirectoriesDetailsCountriesResponseWrapper
void main() {
  final instance = DirectoriesDetailsCountriesResponseWrapperBuilder();
  // TODO add properties to the builder and call build()

  group(DirectoriesDetailsCountriesResponseWrapper, () {
    // String status
