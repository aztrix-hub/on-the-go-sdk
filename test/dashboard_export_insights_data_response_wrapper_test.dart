...
// tests for DashboardExportInsightsDataResponseWrapper
void main() {
  final instance = DashboardExportInsightsDataResponseWrapperBuilder();
  // TODO add properties to the builder and call build()

  group(DashboardExportInsightsDataResponseWrapper, () {
    // String status
