...
// tests for CheckConflictRequest
void main() {
  final instance = CheckConflictRequestBuilder();
  // TODO add properties to the builder and call build()

  group(CheckConflictRequest, () {
    // BuiltList<int> businesses
    test('to test the property `businesses`', () async {
      // TODO
    });

    // BuiltList<int> locations
    test('to test the property `locations`', () async {
      // TODO
    });

    // BuiltList<int> excludedLocations
    ...
    // int ignoreRule
    test('to test the property `ignoreRule`', () async {
      // TODO
    });
  });
}
