...
// tests for ListDirectoryPagesResponseWrapper
void main() {
  final instance = ListDirectoryPagesResponseWrapperBuilder();
  // TODO add properties to the builder and call build()

  group(ListDirectoryPagesResponseWrapper, () {
    // String status
    ...
    // ListDirectoryPagesResponse response
