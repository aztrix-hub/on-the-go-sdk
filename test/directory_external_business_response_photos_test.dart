...
// tests for DirectoryExternalBusinessResponsePhotos
void main() {
  final instance = DirectoryExternalBusinessResponsePhotosBuilder();
  // TODO add properties to the builder and call build()

  group(DirectoryExternalBusinessResponsePhotos, () {
