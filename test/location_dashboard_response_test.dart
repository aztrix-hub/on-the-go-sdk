...
// tests for LocationDashboardResponse
void main() {
  final instance = LocationDashboardResponseBuilder();
  // TODO add properties to the builder and call build()

  group(LocationDashboardResponse, () {
    ...
    // JsonObject todos
    test('to test the property `todos`', () async {
      // TODO
    });
  });
}
