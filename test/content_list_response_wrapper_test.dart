...
// tests for ContentListResponseWrapper
void main() {
  final instance = ContentListResponseWrapperBuilder();
  // TODO add properties to the builder and call build()

  group(ContentListResponseWrapper, () {
    // String status
    ...
    // ContentListResponseObject response
