...
// tests for ConnectFlowUserDetails
void main() {
  final instance = ConnectFlowUserDetailsBuilder();
  // TODO add properties to the builder and call build()

  group(ConnectFlowUserDetails, () {
    ...
    test('to test the property `dateConnected`', () async {
      // TODO
    });
    ...
    test('to test the property `defaultForSalesPartner`', () async {
      // TODO
    });
    ...
    test('to test the property `defaultForBusiness`', () async {
      // TODO
    });
  });
}
